...
public class KwglActivity extends BaseActivity {
    ...
    protected void initView() {
        ...
        arrayAdapter = new ArrayAdapter<>(KwglActivity.this, android.R.layout.simple_list_item_1, lists);
        ...
        listView.setOnItemLongClickListener(new AdapterView.OnItemLongClickListener() {
            ...
            public boolean onItemLongClick(AdapterView<?> adapterView, View view, int i, long l) {
                Toast.makeText(KwglActivity.this, list_tz.get(i).getUrl(), Toast.LENGTH_SHORT).show();
                return true;
            }
        });
    }
        ...
        new Thread() {
            public void run() {
                ...
                try {
                    ...
                    String url = "http://jwc.neau.edu.cn/wejlist.jsp?a3t=20&a3p=1&a3c=100&urltype=tree.TreeTempUrl&wbtreeid=1988";
